  ...
  return(
    <div className="py-12 bg-gray-900">
      <div className="text-center">
        <h2 className="text_base text-teal-600 font-semibold tracking-wide uppercase">Featured COURSES</h2>
      ...
      <div className="mt-10">
        ...
        <BackgroundGradient className="flex flex-col rounded-[22px] bg-white dark:bg-zinc-900 overflow-hidden h-full max-w-sm">
          <div classNae="p-4 sm:p-6 flex flex-col items-center text-center flex-grow">
